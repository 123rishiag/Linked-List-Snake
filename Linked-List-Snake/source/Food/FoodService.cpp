...
namespace Food
{
	...
	sf::Vector2i FoodService::getRandomPosition()
	{
		...
		std::uniform_int_distribution<int> x_distribution(0, LevelModel::number_of_rows - 1);
		std::uniform_int_distribution<int> y_distribution(0, LevelModel::number_of_columns - 1);
	...
	bool FoodService::isValidPosition(std::vector<sf::Vector2i> position_data, sf::Vector2i food_position) const
	{
